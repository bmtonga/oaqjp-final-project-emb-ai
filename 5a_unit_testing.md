...
This document contains the unit tests for the Emotion Detection application.

## Test File: `test_emotion_detection.py`
...
| Test Method | Input Statement | Expected Dominant Emotion |
|---|---|---|
| `test_emotion_detector_joy` | "I am glad this happened" | joy |
| `test_emotion_detector_anger` | "I am really mad about this" | anger |
| `test_emotion_detector_disgust` | "I feel disgusted just hearing about this" | disgust |
| `test_emotion_detector_sadness` | "I am so sad about this" | sadness |
| `test_emotion_detector_fear` | "I am really afraid that this will happen" | fear |

All five tests use mocked API responses to verify that the `emotion_detector` function correctly identifies the dominant emotion for each corresponding input statement.
